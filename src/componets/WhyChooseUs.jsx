      ...
      <div className="gadgetContainer">
        ...
        <div className="text-center md:text-left mt-20">
          <p className="font-semibold text-[#FF497C] mb-3 text-center md:text-left">
            <span className="bg-[#FF497C] text-white mr-3 text-xl font-medium px-2 py-1 rounded-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mt-8">
          <div className="py-6 px-2 shadow border flex justify-center items-center flex-col gap-4">
            <img src={choose1} alt="" />
